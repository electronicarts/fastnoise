...
fastnoise::Context *m_fastnoiseContext = nullptr;

m_fastnoiseContext = fastnoise::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

fastnoise::OnNewFrame(FramesInFlight)
...
fastnoise::DestroyContext(m_fastnoiseContext);
...
fastnoise::Context::s_techniqueLocation = L"./"
...
fastnoise::Execute(m_fastnoise, m_device, m_commandList);
...
fastnoise::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

fastnoise::Context::PerfEventBeginFn
fastnoise::Context::PerfEventEndFn

=====================================================================================================
10) Optional: Hook up imgui for automatic UI of technique inputs
=====================================================================================================

if (m_fastnoise && ImGui::CollapsingHeader("fastnoise"))
    outline::MakeUI(m_fastnoise);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("fastnoise", fastnoise::CreateModule);

in the python module, you will need to "import fastnoise", and when will be able to set user exposed
variables like:

fastnoise.Set_<variable name>(<value>);
